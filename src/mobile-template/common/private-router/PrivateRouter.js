...
import { DashboardMobile, CertificateMobile, ProfileMobile, CourseMobile, CourseMobile2,
    SeriesMobile, SocialMobile, EventMobile, ExamTestMobile } from '../../index'
    ...
    return (
        <>
            <LayoutContent>
                ...
                <Route path={URL_PAGE.SOCIAL} component={(props) => <ExamTestMobile {...props} title="Kiểm tra đánh giá"/>} />
