...
import imgBannerDesktop from '../../assets/img/blackfriday/BF2021.jpg'
import imgBannerMobie from '../../assets/img/blackfriday/BF2021_mobile.jpg'
...
export default function BlackFriday() {
    ...
    return (
        ...
        >
            ...
            <div className=" h-full w-full flex flex-grow border-none      justify-center flex-col   ">
                ...
                <DesktopResponsive>
                    <div className="flex justify-center items-center  relative w-full m-0">
                        ...
                        <img src={imgBannerDesktop} alt="" className="w-full inline-block h-140 object-cover m-0" />
                        <p className="absolute bottom-2 left-1/2 text-white">Chỉ áp dụng cho các khóa học tại CyberLearn.vn</p>
                        <div
                            style={{ transform: "translateX(-230px) translateY(-20px)" }}
                ...
                <TabletResponsive>
                    <div className="flex flex-col justify-center items-center space-y-5">
                        <div className="flex justify-center items-center  relative w-full ">
                            ...
                            <img src={imgBannerDesktop} alt="" className="w-full inline-block h-96 object-cover" />
                            <p className="absolute bottom-2 left-1/2 text-white">Chỉ áp dụng cho các khóa học tại CyberLearn.vn</p>
                            <div
                ...
                <MobileResponsive>
                    <div className="flex justify-center items-center space-y-3 flex-col">
                        <div className="flex justify-center items-center  relative w-full ">
                            ...
                            <img src={imgBannerMobie} alt="" className="w-full inline-block " />
                            <div
                                style={{ transform: "translateX(00px) translateY(105px)" }}
                                className="w-max h-max-content  absolute  ">
                                <WheelComponent
                                    textSize={0.7}
                                    sizeBtnStart={40}
                            ...
                            <p className="absolute bottom-2 left-5 text-white">Chỉ áp dụng cho các khóa học tại CyberLearn.vn</p>
                        </div>
